...
-->
<b style="font-weight: bold;">Metode Pengiriman</b><br/>
<small>
			...
			$(this).click(function(){
				...
				if($(this).data("aktif") == "no"){
					...
					if(hitungJumlah() > 1){
						...
						swal.fire("Error!","Tidak dapat menonaktifkan kurir ini, Anda harus mengaktifkan minimal 1 Metode Pengiriman untuk toko Anda","error");
					}
				}
			});
		});
