	...
	<form class="bg0 p-t-75 p-b-85" id="cekout">
        ...
        <div class="row m-l-0 m-r-0 p-t-20 p-b-20">
          ...
          <div class="col-md-7 p-tb-0">
            <b>d</b>
            <div class="m-t-10">
              <button type="button" id="nodrop" class="btn btn-primary"><i class="fa fa-check-square"></i> Tidak d</button>
              <button type="button" id="yesdrop" class="btn btn-outline-primary"><i class="fa fa-check-square" style="display:none"></i> d</button>
            </div>
